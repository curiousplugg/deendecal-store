...
PROFILE_NAME = os.getenv("LATE_PROFILE_NAME", "deendecal1")
TIMEZONE = os.getenv("TIMEZONE", "America/New_York")
VIDEO_DIR = Path(__file__).parent / os.getenv("VIDEO_DIR", "used2")

# Posting time windows (hour ranges)
POSTING_WINDOWS = [
    (5, 6),   # 5-6 AM
    (7, 8),   # 7-8 AM
    (10, 11), # 10-11 AM
...
TIKTOK_ACCOUNT_ID = "69284b44f43160a0bc999419"
INSTAGRAM_ACCOUNT_ID = "69284812f43160a0bc999415"
YOUTUBE_ACCOUNT_ID = "69285c1bf43160a0bc999459"
PROFILE_ID = "692847c0f209987ce22ce1d8"
...
def main():
    ...
    print("🚀 Starting Late API Post Scheduler")
